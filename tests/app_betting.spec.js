...
const CITIES = ['London', 'Wrocław', 'Dubai', 'Vancouver', 'paris', 'los angeles', 'cairo', 'kathmandu', 'la paz'];
...
test.describe('', () => {
  ...
  test('SCENARIO: Winning bets for Rain market are calculated correctly', async ({ browser }) => {
    ...
    // Extract odds values
    let [rainOdds, noRainOdds, cloudsOdds, noCloudsOdds, fogOdds, noFogOdds] = await extraxtingOdds(page);
    console.log("☑️ Odds for Rain:", rainOdds, noRainOdds);
    ...
    page.on('dialog', dialog => console.log('#️⃣ DIALOG:', dialog.message()));
  ...
  test('SCENARIO: Winning bets for Clouds market are calculated correctly', async ({ browser }) => {
    ...
    // Extract odds values
    let [rainOdds, noRainOdds, cloudsOdds, noCloudsOdds, fogOdds, noFogOdds] = await extraxtingOdds(page);
    console.log("☑️ Odds for Clouds:", cloudsOdds, noCloudsOdds);
  ...
  test('SCENARIO: Winning bets for Fog market are calculated correctly', async ({ browser }) => {
    ...
    // Extract odds values
    let [rainOdds, noRainOdds, cloudsOdds, noCloudsOdds, fogOdds, noFogOdds] = await extraxtingOdds(page);
    console.log("☑️ Odds for Fog:", fogOdds, noFogOdds);
